...
def pong(player1_name, player2_name, message, game_server):
    ...
    while not exit_program and start:
        ...
        if abs(score1 - score2) > 2:
            ...
            if score1 - score2 > 0:
                if "tm" in message:
                    victory_json.update({"winner":(player1_name, (sock2.getsockname()[0], sock2.getsockname()[1]))})
                ...
                if "tm" in message:
                    victory_json.update({"winner":(player2_name, (sock2.getsockname()[0], sock2.getsockname()[1]))})
